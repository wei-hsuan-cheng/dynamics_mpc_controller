...
ForwardDynamicsStateInputCost::ForwardDynamicsStateInputCost(
  ocs2::matrix_t R,
...
ocs2::scalar_t ForwardDynamicsStateInputCost::getValue(
  ocs2::scalar_t time,
...
ocs2::ScalarFunctionQuadraticApproximation ForwardDynamicsStateInputCost::getQuadraticApproximation(
  ocs2::scalar_t time,
  const ocs2::vector_t& state,
  const ocs2::vector_t& input,
  const ocs2::TargetTrajectories& targetTrajectories,
