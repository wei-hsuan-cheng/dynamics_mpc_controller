...
def generate_launch_description():
    ...
    controllers_default = PathJoinSubstitution([mpc_share, "config", "dual_ur5", "forward_dynamics_mpc_controller.yaml"])
    ...
    mujoco_model_path = PathJoinSubstitution(
        [mpc_share, "description", "dual_ur5", "mujoco", LaunchConfiguration("mujocoModelFile")]
    )
    ...
    controller_sequence = ExecuteProcess(
        cmd=[
            ...
            "/robot_description",
            "--controller-name",
            LaunchConfiguration("controllerName"),
            "--timeout",
            "120",
        ],
        output="screen",
